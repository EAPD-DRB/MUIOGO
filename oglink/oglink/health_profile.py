...
Health Investments": an age-specific mortality shock
...
matter pollution, by age, Philippines). Until that CSV
...
def placeholder_profile(num_ages: int = 100) -> np.ndarray:
    ...
    real GBD profile is loaded. The SHAPE matters; magnitude is set by kappa."""
...
def working_age_profile(E: int, S: int, prime_lo: float = 25.0, prime_hi: float = 54.0,
    ...
    at the young and old. NOT calibrated -- a real shape needs GBD YLD/DALY-by-age data.
