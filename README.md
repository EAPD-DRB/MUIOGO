...
This installs runtime dependencies **plus** `pytest`, `ruff`, `coverage`, and `pytest-cov`.
...
This installs runtime dependencies **plus** `pyinstaller`, `pywin32-ctypes`, `pefile`, and related tools.
